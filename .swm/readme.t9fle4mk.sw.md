...
That's all. Now, you can access either <http://localhost:3000> or <http://host-ip:3000> in a browser, and use initial admin user to log in (email: [admin@admin.com](mailto:admin@admin.com), password: foobar).
